...
from nexolu_auth.config import Settings, get_settings
...
def get_engine() -> AsyncEngine:
    ...
    return create_async_engine(
        ...
        # query". Aca duele mas que en los otros servicios: la primera
        # peticion despues de un rato quieto es, justamente, un login.
        #
