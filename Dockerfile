# FastAPI + Uvicorn -- mismo patron que nexolu-comms-api / nexolu-ia-core /
...
# deploy.sh) -- este contenedor NUNCA migra solo al arrancar.
CMD ["uvicorn", "nexolu_auth.main:app", "--host", "0.0.0.0", "--port", "8000"]
